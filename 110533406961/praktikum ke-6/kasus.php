...
<h3> Kambinasi dan Paging </h3>
<body>
   <form action="<?php $_SERVER['PHP_SELF']; ?>" method="get">
        <?php $jum=(isset($_GET['jum'])?$_GET['jum']: 1) ; ?>
Jumlah tampilan : <select name="jum">
...
<thead>
<tr>
<td style="background-color:#00FF00" align="center">No.</td>
<td style="background-color:#00FF00" align="center">NIM</td>
<td style="background-color:#00FF00" align="center">Nama</td>
<td style="background-color:#00FF00" align="center">Alamat</td>
</tr>
</thead>
<tbody>
<?php
